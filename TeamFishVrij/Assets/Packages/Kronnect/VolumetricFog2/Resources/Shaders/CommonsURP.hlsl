...
// Uncomment to enable blue noise
//#define FOG_BLUE_NOISE

// Uncomment to improve compatibility with WebGL
//#define WEBGL_COMPATIBILITY_MODE

// Uncomment to enable fog void rotation (this macro is also defined in VolumetricFogManager.cs)
//#define FOG_VOID_ROTATION

// Uncomment to use world-space based noise
#define USE_WORLD_SPACE_NOISE

// Uncomment to allow rotation of fog volumes
//#define FOG_ROTATION
